  ...
  return (
    <div className={`tonearm-container ${isPlaying ? 'playing' : 'resting'}`}>
      ...
      >
        ...
        {/* Orange core */}
        <circle cx="30" cy="18" r="4.5" fill="#ff6200" opacity="0.95" />
        {/* Center dot */}
        <circle cx="30" cy="18" r="2"   fill="#ff8c3a" />
        ...
        {/* ── Stylus needle ── */}
        <line x1="92" y1="164" x2="92" y2="174" stroke="#ff6200" strokeWidth="1.2" strokeLinecap="round" />
        <circle cx="92" cy="175"  r="1.8" fill="#ff6200" />
        <circle cx="92" cy="175"  r="0.8" fill="#ffaa60" />
